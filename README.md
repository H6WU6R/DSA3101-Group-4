...
2. Created a new feature called 'Income_bin' from 'EstimatedSalary', which assign customers to their corresponding income interval. Then, merged with Digital Marketing Campaign Dataset on 'Age', 'Gender', and 'Income_bin'.
