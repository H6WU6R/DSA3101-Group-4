...
from .A3_Behavioral_Patterns.A3_main import main as A3_main
...
from .B2_Campaign_Optimization.B2_main import main as B2_main
...
if __name__ == "__main__":
    ...
    print("-------------------------- Running B2: Campaign Optimization --------------------------\n")
    B2_main()
